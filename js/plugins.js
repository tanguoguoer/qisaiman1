!function(e, t) {
      ...
      , V = (i, s, e=!0) => {
        if (e) {
            e = (e => {
                ...
                i = i.split(",")[0],
                (Number.parseFloat(t) + Number.parseFloat(i)) * D) : 0
            }
            )(s) + 5;
            let t = !1;
            const n = ({target: e}) => {
                e === s && (t = !0,
                s.removeEventListener(j, n),
                c(i))
            }
            ;
    ...
    class be extends he {
        ...
        _initEvents() {
            this._supportPointerEvents ? (y.on(this._element, "pointerdown.bs.swipe", e => this._start(e)),
            y.on(this._element, "pointerup.bs.swipe", e => this._end(e)),
            this._element.classList.add("pointer-event")) : (y.on(this._element, "touchstart.bs.swipe", e => this._start(e)),
    ...
    class Pe extends t {
        ...
        to(e) {
            ...
            e > i.length - 1 || e < 0 || (this._isSliding ? y.one(this._element, _e, () => this.to(e)) : (t = this._getItemIndex(this._getActive())) !== e && (t = t < e ? we : m,
            this._slide(t, i[e])))
        }
        dispose() {
        ...
        _setActiveIndicatorElement(e) {
            if (this._indicatorsElement) {
                const t = h.findOne(Se, this._indicatorsElement)
                  , i = (t.classList.remove(Ee),
                t.removeAttribute("aria-current"),
                h.findOne(`[data-bs-slide-to="${e}"]`, this._indicatorsElement));
                i && (i.classList.add(Ee),
    ...
    y.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", function(e) {
        ...
        if (t && t.classList.contains(Te)) {
            ...
            return e ? (i.to(e),
            void i._maybeEnableCycle()) : ("next" === u.getDataAttribute(this, "slide") ? i.next() : i.prev(),
                ...
                if (!(e = this._config.parent ? this._getFirstLevelChildren(".collapse.show, .collapse.collapsing").filter(e => e !== this._element).map(e => De.getOrCreateInstance(e, {
                    ...
                    if (!t.defaultPrevented) {
                        ...
                        this._queueCallback( () => {
                            ...
                            this._element.classList.add(g, Ie),
        ...
        hide() {
            if (!this._isTransitioning && this._isShown()) {
                ...
                if (!e.defaultPrevented) {
                    ...
                    R(this._element),
                    this._element.classList.add(Le),
                    this._element.classList.remove(g, Ie);
        ...
        fn: function(e) {
            ...
            Object.keys(n.elements).forEach(function(e) {
                var t = n.styles[e] || {}
                  , i = n.attributes[e] || {}
                  , s = n.elements[e];
                x(s) && v(s) && (Object.assign(s.style, t),
        ...
        effect: function(e) {
            ...
            function() {
                Object.keys(s.elements).forEach(function(e) {
                    ...
                    x(t) && v(t) && (Object.assign(t.style, e),
                    Object.keys(i).forEach(function(e) {
                        t.removeAttribute(e)
                    }))
                })
    ...
    function tt(e, t) {
        ...
        var i = e.getBoundingClientRect()
          , s = 1
          , n = 1;
        return x(e) && t && (t = e.offsetHeight,
        0 < (e = e.offsetWidth) && (s = et(i.width) / e || 1),
        0 < t && (n = et(i.height) / t || 1)),
        {
            width: i.width / s,
            height: i.height / n,
            top: i.top / n,
    ...
    function ot(e) {
        for (var t, i = w(e), s = rt(e); s && (t = s,
        0 <= ["table", "td", "th"].indexOf(v(t))) && "static" === _(s).position; )
            s = rt(s);
    ...
    var ht = {
        ...
        phase: "main",
        fn: function(e) {
            var t, i, s, n, r = e.state, o = e.name, e = e.options, a = r.elements.arrow, l = r.modifiersData.popperOffsets, c = at(d = O(r.placement)), d = 0 <= [P, M].indexOf(d) ? "height" : "width";
            a && l && (e = e.padding,
            i = r,
            i = dt("number" != typeof (e = "function" == typeof e ? e(Object.assign({}, i.rects, {
            ...
            a = (a = ot(a)) ? "y" === c ? a.clientHeight || 0 : a.clientWidth || 0 : 0,
            n = i[n],
            i = a - e[d] - i[s],
            n = lt(n, s = a / 2 - e[d] / 2 + (t / 2 - l / 2), i),
    ...
    function ft(e) {
        var t, i, s, n = e.popper, r = e.popperRect, o = e.placement, a = e.variation, l = e.offsets, c = e.position, d = e.gpuAcceleration, u = e.adaptive, h = e.roundOffsets, e = e.isFixed, p = l.x, p = void 0 === p ? 0 : p, m = l.y, m = void 0 === m ? 0 : m, f = "function" == typeof h ? h({
            x: p,
            y: m
        }) : {
            x: p,
        ...
        m = f.y,
        l.hasOwnProperty("x")), l = l.hasOwnProperty("y"), g = P, v = k, y = window, n = (u && (i = "clientHeight",
        t = "clientWidth",
        (s = ot(n)) === w(n) && "static" !== _(s = T(n)).position && "absolute" === c && (i = "scrollHeight",
        t = "scrollWidth"),
        o !== k && (o !== P && o !== M || a !== b) || (v = A,
        m = (m - ((e && s === y && y.visualViewport ? y.visualViewport.height : s[i]) - r.height)) * (d ? 1 : -1)),
        o !== P && (o !== k && o !== A || a !== b) || (g = M,
        p = (p - ((e && s === y && y.visualViewport ? y.visualViewport.width : s[t]) - r.width)) * (d ? 1 : -1))),
        Object.assign({
            position: c
        }, u && mt)), e = !0 === h ? (o = (i = {
            x: p,
        ...
        return p = e.x,
        m = e.y,
        d ? Object.assign({}, n, ((s = {})[v] = l ? "0" : "",
        s[g] = f ? "0" : "",
        s.transform = (y.devicePixelRatio || 1) <= 1 ? "translate(" + p + "px, " + m + "px)" : "translate3d(" + p + "px, " + m + "px, 0)",
        s)) : Object.assign({}, n, ((t = {})[v] = l ? m + "px" : "",
        t[g] = f ? p + "px" : "",
        t.transform = "",
        t))
    }
    ...
    function At(e, t) {
        ...
        a = s.offsetTop)),
        {
            ...
            x: o + Et(i),
            y: a
        })) : Qe(t) ? ((r = tt(s = t)).top = r.top + s.clientTop,
        ...
        t = C(o.scrollWidth, o.clientWidth, a ? a.scrollWidth : 0, a ? a.clientWidth : 0),
        e = C(o.scrollHeight, o.clientHeight, a ? a.scrollHeight : 0, a ? a.clientHeight : 0),
        n = -i.scrollLeft + Et(n),
        i = -i.scrollTop,
        "rtl" === _(a || o).direction && (n += C(o.clientWidth, a ? a.clientWidth : 0) - t),
        {
            width: t,
            height: e,
            x: n,
    ...
    function Mt(i, e, t) {
        var s, n = "clippingParents" === e ? (r = Ct(nt(n = i)),
        Qe(s = 0 <= ["absolute", "fixed"].indexOf(_(n).position) && x(n) ? ot(n) : n) ? r.filter(function(e) {
    ...
    function Pt(e) {
        var t, i = e.reference, s = e.element, e = e.placement, n = e ? O(e) : null, e = e ? pt(e) : null, r = i.x + i.width / 2 - s.width / 2, o = i.y + i.height / 2 - s.height / 2;
        switch (n) {
        case k:
            t = {
                x: r,
    ...
    function It(e, t) {
        var s, t = t = void 0 === t ? {} : t, i = t.placement, i = void 0 === i ? e.placement : i, n = t.boundary, n = void 0 === n ? Ne : n, r = t.rootBoundary, r = void 0 === r ? Fe : r, o = t.elementContext, o = void 0 === o ? He : o, a = t.altBoundary, a = void 0 !== a && a, t = t.padding, t = void 0 === t ? 0 : t, t = dt("number" != typeof t ? t : ut(t, I)), l = e.rects.popper, a = e.elements[a ? o === He ? qe : He : o], a = Mt(Qe(a) ? a : a.contextElement || T(e.elements.popper), n, r), n = tt(e.elements.reference), r = Pt({
            reference: n,
            element: l,
            strategy: "absolute",
            placement: i
        }), l = kt(Object.assign({}, l, r)), r = o === He ? l : n, c = {
    ...
    var Nt = {
        ...
        phase: "main",
        fn: function(e) {
            var t, i, s, n, r, o, a, l, c, d = e.state, u = e.options, e = e.name, h = void 0 === (h = u.mainAxis) || h, p = void 0 !== (p = u.altAxis) && p, m = u.boundary, f = u.rootBoundary, g = u.altBoundary, v = u.padding, y = void 0 === (y = u.tether) || y, u = void 0 === (u = u.tetherOffset) ? 0 : u, m = It(d, {
                boundary: m,
                rootBoundary: f,
                padding: v,
                altBoundary: g
            }), f = O(d.placement), g = !(v = pt(d.placement)), b = at(f), w = "x" === b ? "y" : "x", x = d.modifiersData.popperOffsets, _ = d.rects.reference, T = d.rects.popper, u = "number" == typeof (u = "function" == typeof u ? u(Object.assign({}, d.rects, {
                ...
                mainAxis: 0,
                altAxis: 0
            }, u), E = d.modifiersData.offset ? d.modifiersData.offset[d.placement] : null, S = {
                x: 0,
                y: 0
            };
            ...
            i = (s = d.modifiersData["arrow#persistent"] ? d.modifiersData["arrow#persistent"].padding : ct())[i],
            s = s[c],
            c = lt(0, _[h], r[h]),
            r = g ? _[h] / 2 - t - c - i - u.mainAxis : n - c - i - u.mainAxis,
            n = g ? -_[h] / 2 + t + c + s + u.mainAxis : v + c + s + u.mainAxis,
            g = (i = d.elements.arrow && ot(d.elements.arrow)) ? "y" === b ? i.clientTop || 0 : i.clientLeft || 0 : 0,
            v = a + n - (t = null != (h = null == E ? void 0 : E[b]) ? h : 0),
            c = lt(y ? Je(o, a + r - t - g) : o, a, y ? C(l, v) : l),
            x[b] = c,
            S[b] = c - a),
            ...
            a = y && r ? (l = lt(l = o, i, c = v),
            c < l ? c : l) : lt(y ? o : n, i, y ? v : h),
            x[w] = a,
            S[w] = a - i),
            d.modifiersData[e] = S)
        },
    ...
    function Ft(e, t, i) {
        void 0 === i && (i = !1);
        var s = x(t)
          , n = x(t) && (o = (n = t).getBoundingClientRect(),
        ...
        x(t) ? ((a = tt(t, !0)).x += t.clientLeft,
        a.y += t.clientTop) : r && (a.x = Et(r))),
        {
    ...
    class E extends t {
        constructor(e, t) {
            ...
            this._menu = h.findOne(Qt, this._parent),
    ...
    y.on(document, Ve, Ut, E.dataApiKeydownHandler),
    y.on(document, Ve, Qt, E.dataApiKeydownHandler),
    y.on(document, Ye, E.clearMenus),
    y.on(document, "keyup.bs.dropdown.data-api", E.clearMenus),
    y.on(document, Ye, Ut, function(e) {
        e.preventDefault(),
    ...
    class ci {
        ...
        hide() {
            ...
            this._setElementAttributes(ri, ai, e => e + t),
            this._setElementAttributes(oi, li, e => e - t)
        }
        reset() {
        ...
        _resetElementAttributes(e, i) {
            this._applyManipulationCallback(e, e => {
                ...
                null === t ? e.style.removeProperty(i) : (u.removeDataAttribute(e, i),
    ...
    class mi extends he {
        ...
        dispose() {
            this._isAppended && (y.off(this._element, ui),
            this._element.remove(),
            this._isAppended = !1)
        }
        _getElement() {
    ...
    class Qi extends t {
        ...
        toggle(e) {
            if (this._isEnabled) {
                if (e) {
                    ...
                    return t._activeTrigger.click = !t._activeTrigger.click,
        ...
        dispose() {
            ...
            y.off(this._element.closest(".modal"), Wi, this._hideModalHandler),
            ...
            if (this._isWithContent() && this._isEnabled) {
                ...
                if (!e.defaultPrevented && t) {
                    ...
                    const s = this._getTipElement()
                      , n = (this._element.setAttribute("aria-describedby", s.getAttribute("id")),
        ...
        _createTipElement(e) {
            ...
            this._isAnimated() && t.classList.add(Bi),
            t
        }
        setContent(e) {
            this._newContent = e,
        ...
        _setListeners() {
            ...
            for (const i of this._config.trigger.split(" "))
                "click" === i ? y.on(this._element, this.constructor.eventName("click"), this._config.selector, e => this.toggle(e)) : "manual" !== i && (e = i === Yi ? this.constructor.eventName("mouseenter") : this.constructor.eventName("focusin"),
            ...
            ,
            y.on(this._element.closest(".modal"), Wi, this._hideModalHandler),
    ...
    class rs extends t {
        ...
        _maybeEnableSmoothScroll() {
            this._config.smoothScroll && (y.off(this._config.target, es),
            y.on(this._config.target, es, is, e => {
        ...
        _initializeTargetsAndObservables() {
            ...
            this._targetLinks = new Map,
            this._observableSections = new Map;
            for (const t of h.find(is, this._config.target))
                t.hash && !a(t) && (e = h.findOne(t.hash, this._element),
        ...
        _activateParents(e) {
            if (e.classList.contains("dropdown-item"))
                h.findOne(".dropdown-toggle", e.closest(".dropdown")).classList.add(ts);
            else
    ...
    class ds extends t {
        ...
        _activate(e, t) {
            ...
            this._activate(r(e)),
            this._queueCallback( () => {
                "tab" !== e.getAttribute("role") ? e.classList.add(ls) : (e.focus(),
        ...
        _deactivate(e, t) {
            e && (e.classList.remove(z),
            e.blur(),
            this._deactivate(r(e)),
            this._queueCallback( () => {
                "tab" !== e.getAttribute("role") ? e.classList.remove(ls) : (e.setAttribute("aria-selected", !1),
        ...
        _keydown(e) {
            var t;
            ["ArrowLeft", os, "ArrowUp", as].includes(e.key) && (e.stopPropagation(),
            e.preventDefault(),
            t = [os, as].includes(e.key),
            (e = X(this._getChildren().filter(e => !a(e)), e.target, t, !0)) && ds.getOrCreateInstance(e).show())
        }
        _getChildren() {
    ...
    y.on(document, "click.bs.tab", ht, function(e) {
        ["A", "AREA"].includes(this.tagName) && e.preventDefault(),
        a(this) || ds.getOrCreateInstance(this).show()
    }),
    ...
    class fs extends t {
        ...
        show() {
            ...
            R(this._element),
            this._element.classList.add(us, hs),
            this._queueCallback( () => {
        ...
        hide() {
            this.isShown() && !y.trigger(this._element, "hide.bs.toast").defaultPrevented && (this._element.classList.add(hs),
            this._queueCallback( () => {
                this._element.classList.add("hide"),
                this._element.classList.remove(hs, us),
        ...
        dispose() {
            this._clearTimeout(),
            this.isShown() && this._element.classList.remove(us),
            super.dispose()
        }
        isShown() {
...
function(e, t) {
    ...
    e(f, [{
        ...
        value: function(s, n) {
            ...
            q(l) ? (o.title || "a" != i || (q(t = s.title) || "" === t || (o.title = t)),
            o.title || "img" != i || (q(t = s.alt) || "" === t || (o.title = t))) : (a = [],
            h(o, function(e, t) {
                a.push(";\\s?" + t)
            }),
            a = a.join("\\s?:|"),
            ...
            "video" === a)
                ...
                if ("external" !== a)
                    return "inline" === a ? (function(e, t, i, s) {
                        ...
                        H(a) && ("none" == a.style.display && (a.style.display = "block"),
                    ...
                    void m.insertBefore(o, m.firstChild)) : void (F(p) && p());
            ...
            L("click", {
                ...
                withCallback: function(e, t) {
                    ...
                    var n = L("click", {
                        ...
                        withCallback: function(e, t) {
                            "a" !== e.target.nodeName.toLowerCase() && ($(i, "gdesc-open"),
                            O(i, "gdesc-closed"),
    ...
    var Z = y()
      ...
      , ie = (e(T, [{
        ...
        value: function() {
            ...
            var s, n, r, o, i, a, l, c, d, u, h, p, m, f, g, v, y, b, w, x, _, T, E, S, C, k, A, M, P, t = B(t) ? t : this.settings.startAt, I = (H(e) && ((I = e.getAttribute("data-gallery")) && (this.fullElementsList = this.elements,
            ...
            O(this.nextButton, "glightbox-button-hidden")) : ($(this.prevButton, "glightbox-button-hidden"),
            ...
            e = new V(e,{
                touchStart: function(e) {
                    o = !0,
                    (z(e.targetTouches[0].target, "ginner-container") || D(e.targetTouches[0].target, ".gslide-desc") || "a" == e.targetTouches[0].target.nodeName.toLowerCase()) && (o = !1),
                    (o = D(e.targetTouches[0].target, ".gslide-inline") && !z(e.targetTouches[0].target.parentNode, "gslide-inline") ? !1 : o) && (S = e.targetTouches[0],
                    ...
                    l = null,
                    z(a, "gslide-image") && (l = a.querySelector("img")),
                ...
                touchEnd: function() {
                    ...
                    if (o)
                        return c = !1,
                        p || h ? (g = m,
                        void (v = f)) : (e = Math.abs(parseInt(x)),
                        t = Math.abs(parseInt(w)),
                        29 < e && l ? void s.close() : e < 29 && t < 25 ? (O(M, "greset"),
                        M.style.opacity = 1,
                        R(a)) : void 0)
                },
            ...
            s.events.touch = e)),
            this.settings.keyboardNavigation && !(P = this).events.hasOwnProperty("keyboard") && (P.events.keyboard = L("keydown", {
                onElement: window,
                withCallback: function(e, t) {
        ...
        value: function() {
            ...
            this.slidesContainer.querySelector(".current")), r = (n && $(n, "current"),
            this.slideAnimateOut(),
            this.slidesContainer.querySelectorAll(".gslide")[i]);
            z(r, "loaded") ? (this.slideAnimateIn(r, s),
        ...
        value: function(e) {
            var t;
            (!Z || null != (t = this.settings.plyr.config) && t.muted) && (H(e) && (t = e.querySelector(".gvideo-wrapper")) && (e = t.getAttribute("data-index")),
        ...
        value: function() {
            ...
            !q(this.settings.elements) && k(this.settings.elements) && this.settings.elements.length && h(this.settings.elements, function(e, t) {
                var e = new x(e,r,t)
                  , i = e.getConfig()
                  , s = c({}, i);
                s.node = !1,
        ...
        value: function() {
            ...
            this.settings.closeButton && s && (this.events.close = L("click", {
                onElement: s,
                withCallback: function(e, t) {
                    e.preventDefault(),
                    i.close()
        ...
        value: function() {
            ...
            r = i.width,
            i = i.height,
            (r <= 768 ? O : $)(document.body, "glightbox-mobile"),
            (e || a) && (s = !1,
            ...
            o = (n = B(a) || -1 !== a.indexOf("px") ? parseInt(a) : -1 !== a.indexOf("vw") ? r * parseInt(a) / 100 : -1 !== a.indexOf("vh") ? i * parseInt(a) / 100 : -1 !== a.indexOf("%") ? r * parseInt(a) / 100 : parseInt(e.clientWidth)) / (parseInt(o[0]) / parseInt(o[1])),
            o = Math.floor(o),
            s && (i -= t.offsetHeight),
        ...
        value: function() {
            ...
            j(this.activeSlide, this.settings.cssEfects[this.settings.closeEffect].out, function() {
                ...
                var t = document.body
                  , t = ($(ee, "glightbox-open"),
                $(t, "glightbox-open touching gdesc-open glightbox-touch glightbox-mobile gscrollbar-fixer"),
...
function(o, a) {
    ...
    function(e) {
        if ("string" != typeof e)
            return e;
        var t, i, s = (e = l(e).split(" "))[0], n = (n = s.match(/^\[(.+)\]$/)) && n[1], r = (i = s,
        (t = n) ? function(e) {
...
function(e, r) {
    ...
    var n, F, o, H, q, B, R, a, l, W, Y, c, d, u, h, p, _ = {}, f = !1, g = r.createElement("img"), v = g.getAttribute, V = g.setAttribute, X = g.removeAttribute, y = r.documentElement, b = {}, T = {
        algorithm: ""
    }, E = "data-pfsrc", G = E + "set", S = navigator.userAgent, U = /rident/.test(S) || /ecko/.test(S) && S.match(/rv\:(\d+)/) && 35 < RegExp.$1, C = "currentSrc", Q = /\s+\+?\d+(e\d+)?w/, K = /(\([^)]+\))?\s*(.+)/, k = e.picturefillCFG, Z = "font-size:100%!important;", A = !0, M = {}, P = {}, I = e.devicePixelRatio, L = {
        px: 1,
        in: 96
    }, J = r.createElement("a"), O = !1, ee = /^[ \t\n\r\u000c]+/, te = /^[, \t\n\r\u000c]+/, ie = /^[^ \t\n\r\u000c]+/, se = /[,]+$/, ne = /^\d+$/, re = /^-?(?:[0-9]+|[0-9]*\.[0-9]+)(?:[eE][+-]?[0-9]+)?$/, oe = (H = /^([\d\.]+)(em|vw|px)$/,
    q = s(function(e) {
    ...
    _.supSrcset && _.supPicture && !_.supSizes && (S = r.createElement("img"),
    g.srcset = "data:,a",
    S.src = "data:,a",
    _.supSrcset = g.complete === S.complete,
    ...
    _.calcListLength = function(e) {
        var t;
        return e in P && !T.uT || (t = _.calcLength(N(e)),
        P[e] = t || L.width),
        P[e]
    }
    ,
    ...
    _.applySetCandidate = function(e, t) {
        if (e.length) {
            var i, s, n, r, o, a, l = t[_.ns], c = _.DPR, d = l.curSrc || t[C], u = l.curCan || (y = t,
            u = d,
            b = e[0].set,
    ...
    _.parseSets = function(e, t, i) {
        ...
        l.src ? V.call(e, E, l.src) : X.call(e, E)),
    ...
    ,
    _.setupRun = function() {
        O && !A && I === e.devicePixelRatio || (A = !1,
        I = e.devicePixelRatio,
        M = {},
        P = {},
        _.DPR = I || 1,
        L.width = Math.max(e.innerWidth || 0, y.clientWidth),
        L.height = Math.max(e.innerHeight || 0, y.clientHeight),
        L.vw = L.width / 100,
        L.vh = L.height / 100,
        o = [L.height, L.width, I].join("-"),
        L.em = _.getEmValue(),
        L.rem = L.em)
    }
    ,
    ...
    d = y.clientHeight,
    i(e, "resize", (R = function() {
        A = Math.max(e.innerWidth || 0, y.clientWidth) !== L.width || y.clientHeight !== d,
        d = y.clientHeight,
        A && _.fillImgs()
    }
    ,
    ...
    e.picturefill = $,
    "object" == typeof module && "object" == typeof module.exports ? module.exports = $ : "function" == typeof define && define.amd && define("picturefill", function() {
        return $
    }),
...
"object" == typeof navigator && function(e, t) {
    ...
    J = [{
        ...
        value: function(i) {
            var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {}
              , e = null;
            if (R(i) || Q(i) ? e = Array.from(document.querySelectorAll(Q(i) ? i : 'input[type="range"]')) : q(i) ? e = [i] : Z(i) ? e = Array.from(i) : K(i) && (e = i.filter(q)),
            R(e))
                return null;
            var s = F({}, H, {}, t);
    ...
    e((Je = o).prototype, [{
        ...
        value: function(e) {
            ...
            i + (t = e / 100 * (s - i),
            (r = n) < 1 ? (e = (e = "".concat(r).match(/(?:\.(\d+))?(?:[eE]([+-]?\d+))?$/)) ? Math.max(0, (e[1] ? e[1].length : 0) - (e[2] ? +e[2] : 0)) : 0,
            parseFloat(t.toFixed(e))) : Math.round(t / r) * r)
        }
    }, {
        key: "set",
        value: function(e) {
            var t;
            o.enabled && B(e) && !e.target.disabled && (e.preventDefault(),
    ...
    function o(e, t) {
        ...
        q(this.element) && R(this.element.rangeTouch) && (this.config = F({}, H, {}, t),
        this.init())
    }
    ...
    function I(e) {
        var t;
        t = e,
        i(t, Promise) && re(t.then) && e.then(null, () => {}
        )
    }
    function Ce(i) {
    ...
    function Le(e) {
        ...
        let i = t(e);
        if (null === (i = null === i ? t(this.config.ratio) : i) && !x(this.embed) && h(this.embed.ratio) && ({ratio: i} = this.embed),
        null === i && this.isHTML5) {
    ...
    const L = {
        ...
        cancelRequests() {
            this.isHTML5 && (f(L.getSources.call(this)),
    ...
    const $ = {
        ...
        createButton(e, t) {
            ...
            ge(r, i),
            "play" === s ? (h(this.elements.buttons[s]) || (this.elements.buttons[s] = []),
        ...
        updateVolume() {
            this.supported.ui && (w(this.elements.inputs.volume) && $.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume),
            w(this.elements.buttons.mute) && (this.elements.buttons.mute.pressed = this.muted || 0 === this.volume))
        },
        setRange(e, t=0) {
            w(e) && (e.value = t,
            $.updateRangeFill.call(this, e))
        },
        updateProgress(e) {
            if (this.supported.ui && d(e)) {
                ...
                if (e)
                    ...
                    case "seeked":
                        ...
                        "timeupdate" === e.type && $.setRange.call(this, this.elements.inputs.seek, t);
                        break;
                    case "playing":
                    case "progress":
        ...
        updateSeekTooltip(t) {
            if (this.config.tooltips.seek && w(this.elements.inputs.seek) && w(this.elements.display.seekTooltip) && 0 !== this.duration) {
                ...
                if (this.touch)
                    ...
                    s.style.left = e + "%",
                    d(t) && ["mouseenter", "mouseleave"].includes(t.type) && r("mouseenter" === t.type)
                }
            }
        },
        timeUpdate(e) {
            var t = !w(this.elements.display.duration) && this.config.invertTime;
            $.updateTimeDisplay.call(this, this.elements.display.currentTime, t ? this.duration - this.currentTime : this.currentTime, t),
            e && "timeupdate" === e.type && this.media.seeking || $.updateProgress.call(this, e)
        },
        durationUpdate() {
            if (this.supported.ui && (this.config.invertTime || !this.currentTime)) {
                ...
                !e && this.config.displayDuration && this.paused && $.updateTimeDisplay.call(this, this.elements.display.currentTime, this.duration),
                e && $.updateTimeDisplay.call(this, this.elements.display.duration, this.duration),
        ...
        updateSetting(e, t, i) {
            ...
            if (w(r) || (r = s && s.querySelector('[role="menu"]')),
            w(r)) {
        ...
        setQualityMenu(e) {
            if (w(this.elements.settings.panels.quality)) {
                ...
                if ($.toggleMenuButton.call(this, t, e),
                ye(i),
                $.checkMenu.call(this),
                e) {
                    const s = e => {
        ...
        setCaptionsMenu() {
            if (w(this.elements.settings.panels.captions)) {
                const i = this.elements.settings.panels.captions.querySelector('[role="menu"]')
                  ...
                  , t = Boolean(e.length);
                if ($.toggleMenuButton.call(this, "captions", t),
                ye(i),
                $.checkMenu.call(this),
                t) {
                    const s = e.map( (e, t) => ({
        ...
        toggleMenu(t) {
            ...
            if (w(i) && w(s)) {
                ...
                v(i, !e),
                T(this.elements.container, this.config.classNames.menu.open, e),
                e && u(t) ? $.focusFirstMenuItem.call(this, null, !0) : e || n || xe.call(this, s, u(t))
            }
        },
        getMenuSize(e) {
        ...
        showMenuPanel(e="", t=!1) {
            ...
            if (w(i)) {
                ...
                v(n, !0),
                v(i, !1),
                $.focusFirstMenuItem.call(this, i, t)
            }
        },
        setDownloadUrl() {
        ...
        create(a) {
            ...
            _("div", g(this.config.selectors.controls.wrapper)))
              , u = (this.elements.controls = r,
            {
                class: "plyr__controls__item"
            });
            return Ce(h(this.config.controls) ? this.config.controls : []).forEach(t => {
                if ("restart" === t && r.appendChild(i.call(this, "restart", u)),
                "rewind" === t && r.appendChild(i.call(this, "rewind", u)),
                "play" === t && r.appendChild(i.call(this, "play", u)),
                "fast-forward" === t && r.appendChild(i.call(this, "fast-forward", u)),
                "progress" === t) {
                    const l = _("div", {
                ...
                if ("current-time" === t && r.appendChild(c.call(this, "currentTime", u)),
                "duration" === t && r.appendChild(c.call(this, "duration", u)),
                "mute" === t || "volume" === t) {
                ...
                if ("captions" === t && r.appendChild(i.call(this, "captions", u)),
                ...
                if ("pip" === t && k.pip && r.appendChild(i.call(this, "pip", u)),
                "airplay" === t && k.airplay && r.appendChild(i.call(this, "airplay", u)),
                "download" === t) {
                    const a = m({}, u, {
                        element: "a",
                        href: this.download,
        ...
        inject() {
            ...
            w(this.config.controls) || l(this.config.controls) ? t = this.config.controls : (t = $.create.call(this, {
                id: this.id,
                seektime: this.config.seekTime,
                speed: this.speed,
            ...
            this.config.tooltips.controls) {
                ...
                Array.from(s).forEach(e => {
                    T(e, this.config.classNames.hidden, !1),
                    T(e, this.config.classNames.tooltip, !0)
                }
                )
            }
        },
        ...
        setMarkers() {
            ...
            if (this.duration && !this.elements.markers) {
                ...
                if (null != t && t.length) {
                    ...
                    i.appendChild(n),
                    this.config.tooltips.seek || (s = _("span", {
                        class: this.config.classNames.tooltip
                    }, ""),
                    i.appendChild(s)),
    ...
    const z = {
        setup() {
            if (this.supported.ui)
                if (!this.isVideo || this.isYouTube || this.isHTML5 && !k.textTracks)
                    ...
                    var i;
                    if (w(this.elements.captions) || (this.elements.captions = _("div", g(this.config.selectors.captions)),
        ...
        update() {
            ...
            (r && this.language !== i || !e.includes(n)) && (z.setLanguage.call(this, i),
            z.toggle.call(this, t && r)),
        ...
        getLabel(e) {
            ...
            de(t) ? x(t.label) ? x(t.language) ? O.get("enabled", this.config) : e.language.toUpperCase() : t.label : O.get("disabled", this.config)
        },
        updateCues(t) {
            if (this.supported.ui)
    ...
    class j {
        constructor(e) {
            ...
            r(this, "toggleFallback", (t=!1) => {
                ...
                T(this.target, this.player.config.classNames.fullscreen.fallback, t),
                p.isIos) {
            ...
            r(this, "update", () => {
                ...
                T(this.player.elements.container, this.player.config.classNames.fullscreen.enabled, this.enabled)
            }
            ),
            r(this, "enter", () => {
            ...
            r(this, "exit", () => {
                ...
                I(this.player.play())) : !j.native || this.forceFallback ? this.toggleFallback(!1) : this.prefix ? x(this.prefix) || (e = "moz" === this.prefix ? "Cancel" : "Exit",
    ...
    const N = {
        addStyleHook() {
            T(this.elements.container, this.config.selectors.container.replace(".", ""), !0),
            T(this.elements.container, this.config.classNames.uiSupported, this.supported.ui)
        },
        ...
        build() {
            ...
            !this.supported.ui)
                ...
                void N.toggleNativeControls.call(this, !0);
            w(this.elements.controls) || ($.inject.call(this),
        ...
        setTitle() {
            ...
            if (l(this.config.title) && !x(this.config.title) && (t += ", " + this.config.title),
        ...
        setPoster(t, e=!0) {
            ...
            .call(this).then( () => Ke(t)).catch(e => {
                throw t === this.poster && N.togglePoster.call(this, !1),
                e
            }
            ).then( () => {
                if (t !== this.poster)
        ...
        checkLoading(e) {
            ...
            this.timers.loading = setTimeout( () => {
                T(this.elements.container, this.config.classNames.loading, this.loading),
                N.toggleControls.call(this)
            }
            , this.loading ? 250 : 0)
        },
        toggleControls(e) {
        ...
        constructor(e) {
            r(this, "firstTouch", () => {
                const e = this["player"]
                  , t = e["elements"];
                e.touch = !0,
                T(t.container, e.config.classNames.isTouch, !0)
            }
            ),
            ...
            r(this, "container", () => {
                const a = this["player"]
                  ...
                  , i = (!e.keyboard.global && e.keyboard.focused && M.call(a, l.container, "keydown keyup", this.handleKey, !1),
                M.call(a, l.container, "mousemove mouseleave touchstart touchmove enterfullscreen exitfullscreen", e => {
                    ...
                    t.hover = !1);
                    let i = 0;
                    ["touchstart", "touchmove", "mousemove"].includes(e.type) && (N.toggleControls.call(a, !0),
                    i = a.touch ? 3e3 : 2e3),
                    clearTimeout(s.controls),
                    s.controls = setTimeout( () => N.toggleControls.call(a, !1), i)
                }
                ),
                () => {
                    if (a.isVimeo && !a.config.vimeo.premium) {
                        ...
                        t = n / r < t / e,
                        o ? (i.style.width = t ? "auto" : "100%",
                        i.style.height = t ? "100%" : "auto") : (i.style.maxWidth = t ? e / r * n + "px" : null,
                        i.style.margin = t ? "0 auto" : null)) : o ? (i.style.width = null,
                ...
                M.call(a, l.container, "enterfullscreen exitfullscreen", e => {
                    ...
                    t !== l.container || !a.isEmbed && x(a.config.ratio) || (i(),
                    ("enterfullscreen" === e.type ? M : Ee).call(a, window, "resize", n))
                }
                )
            }
            ),
            r(this, "media", () => {
                const i = this["player"]
                  , s = i["elements"];
                if (M.call(i, i.media, "timeupdate seeking seeked", e => $.timeUpdate.call(i, e)),
            ...
            r(this, "controls", () => {
                ...
                this.bind(s.buttons.settings, "keyup", e => {
                    ...
                    e.stopPropagation(),
                    $.toggleMenu.call(o, e)) : $.focusFirstMenuItem.call(o, null, !0))
                }
                , null, !1),
                ...
                this.bind(s.inputs.seek, "mousedown mouseup keydown keyup touchstart touchend", e => {
                    const t = e.currentTarget
                      , i = "play-on-seeked";
                    var s;
                    u(e) && !["ArrowLeft", "ArrowRight"].includes(e.key) || (o.lastSeekTime = Date.now(),
                    s = t.hasAttribute(i),
                    e = ["mouseup", "touchend", "keyup"].includes(e.type),
                    s && e ? (t.removeAttribute(i),
                    I(o.play())) : !e && o.playing && (t.setAttribute(i, ""),
                    o.pause()))
                }
                ),
                p.isIos) {
                ...
                this.bind(s.controls, "focusin", () => {
                    ...
                    t.controls = setTimeout( () => N.toggleControls.call(o, !1), i)
                }
                ),
    ...
    const st = {
        ...
        ready() {
            ...
            let n = o.media.getAttribute("src")
              , r = "";
            var a = (r = x(n) ? (n = o.media.getAttribute(o.config.attributes.embed.id),
    ...
    const rt = {
        setup() {
            if (T(this.elements.wrapper, this.config.classNames.embed, !0),
                    ...
                    events: {
                        ...
                        onReady(e) {
                            if (!c(r.media.play)) {
                                ...
                                r.timers.buffering = setInterval( () => {
                                    ...
                                    (null === r.media.lastBuffered || r.media.lastBuffered < r.media.buffered) && P.call(r, r.media, "progress"),
                        ...
                        onStateChange(e) {
                            ...
                            case 0:
                                ...
                                t.playVideo()) : P.call(r, r.media, "ended");
                                break;
                            case 1:
                                o.customControls && !r.config.autoplay && r.media.paused && !r.embed.hasPlayed ? r.media.pause() : (nt.call(r, !0),
      ...
      , ot = {
        setup() {
            this.media ? (T(this.elements.container, this.config.classNames.type.replace("{0}", this.type), !0),
            T(this.elements.container, this.config.classNames.provider.replace("{0}", this.provider), !0),
            this.isEmbed && T(this.elements.container, this.config.classNames.type.replace("{0}", "video"), !0),
            ...
            this.isHTML5 ? L.setup.call(this) : this.isYouTube ? rt.setup.call(this) : this.isVimeo && st.setup.call(this)) : this.debug.warn("No media element found!")
        }
    };
    class at {
        constructor(e) {
            ...
            r(this, "onAdEvent", e => {
                const t = this.player.elements["container"]
                  ...
                  , s = e.getAdData();
                switch (n = e.type,
                P.call(this.player, this.player.media, "ads" + n.replace(/_/g, "").toLowerCase()),
                e.type) {
    ...
    const ut = {
        ...
        change(r) {
            me(r, "sources.length") ? (L.cancelRequests.call(this),
            this.destroy.call(this, () => {
                ...
                x(r.previewThumbnails) || (Object.assign(this.config.previewThumbnails, r.previewThumbnails),
    ...
    class ht {
        constructor(e, t) {
            if (r(this, "play", () => c(this.media.play) ? (this.ads && this.ads.enabled && this.ads.managerPromise.then( () => this.ads.play()).catch( () => I(this.media.play())),
            ...
            r(this, "toggleControls", e => {
                ...
                if (i && h(this.config.controls) && this.config.controls.includes("settings") && !x(this.config.settings) && $.toggleMenu.call(this, !1),
                i !== t) {
            ...
            r(this, "destroy", (e, t=!1) => {
                ...
                this.isHTML5 ? (N.toggleNativeControls.call(this, !0),
            ...
            this.config = m({}, Xe, ht.defaults, t || {}, ( () => {
                try {
                ...
                if (k.check().api) {
                    ...
                    case "div":
                        ...
                        w(e)) {
                            ...
                            /^(https?:\/\/)?(www\.)?(youtube\.com|youtube-nocookie\.com|youtu\.?be)\/.+$/.test(i) ? D.youtube : /^https?:\/\/player.vimeo.com\/video\/\d{0,9}(?=\b|\/)/.test(i) ? D.vimeo : null),
                            this.elements.container = this.media,
                            this.media = e,
                            this.elements.container.className = "",
                            t.search.length) {
                                const r = ["1", "true"];
                                r.includes(t.searchParams.get("autoplay")) && (this.config.autoplay = !0),
                                r.includes(t.searchParams.get("loop")) && (this.config.loop.active = !0),
                                this.isYouTube ? (this.config.playsinline = r.includes(t.searchParams.get("playsinline")),
                    ...
                    w(this.elements.container) || (this.elements.container = _("div", {
                        tabindex: 0
                    }),
        ...
        set ratio(e) {
            this.isVideo ? l(e) && Pe(e) ? (this.config.ratio = Ie(e),
        ...
        static setup(e, t={}) {
            let i = null;
            return l(e) ? i = Array.from(document.querySelectorAll(e)) : ce(e) ? i = Array.from(e) : h(e) && (i = e.filter(w)),
...
var _self = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {}
  , Prism = function(l) {
    var c = /\blang(?:uage)?-([\w-]+)\b/i
      ...
      , $ = {
        ...
        languages: {
            ...
            DFS: function e(t, i, s, n) {
                ...
                for (r in t)
                    ...
                    o = t[r],
                    "Object" !== (a = $.util.type(o)) || n[l(o)] ? "Array" !== a || n[l(o)] || (n[l(o)] = !0,
                    e(o, i, r, n)) : (n[l(o)] = !0,
                    e(o, i, null, n)))
            }
        },
        ...
        highlightElement: function(e, t, i) {
            ...
            if ($.hooks.run("before-sanity-check", o),
            (r = o.element.parentElement) && "pre" === r.nodeName.toLowerCase() && !r.hasAttribute("tabindex") && r.setAttribute("tabindex", "0"),
            !o.code)
                return $.hooks.run("complete", o),
                void (i && i.call(o.element));
            $.hooks.run("before-highlight", o),
            o.grammar ? t && l.Worker ? ((s = new Worker($.filename)).onmessage = function(e) {
                a(e.data)
            }
            ,
        ...
        highlight: function(e, t, i) {
            ...
            return $.hooks.run("before-tokenize", e),
                            ...
                            v = v.next) {
                                ...
                                if (!(b instanceof z)) {
                                    ...
                                    if (m) {
                                        ...
                                        continue;
                                    for (var _ = w.index, C = w[0], k = b.slice(0, _), A = b.slice(_ + C.length), b = y + b.length, M = (o && b > o.reach && (o.reach = b),
                                    v.prev), P = (k && (M = j(i, M, k),
                                    y += k.length),
                                    O = L = I = k = P = void 0,
                                    i), k = M, I = x, L = k.next, O = 0; O < I && L !== P.tail; O++)
                                        L = L.next;
                                    (k.next = L).prev = k,
                                    P.length -= O;
                                    v = j(i, M, new z(a,h ? $.tokenize(C, h) : C,f,C));
                                    A && j(i, v, A),
                                    1 < x && (e(t, i, s, v.prev, y, k = {
                                        cause: a + "," + c,
                                        reach: b
                                    }),
    ...
    return e && ($.filename = e.src,
    e.hasAttribute("data-manual") && ($.manual = !0)),
    $.manual || ("loading" === (i = document.readyState) || "interactive" === i && e && e.defer ? document.addEventListener("DOMContentLoaded", s) : window.requestAnimationFrame ? window.requestAnimationFrame(s) : window.setTimeout(s, 16)),
    $
}(_self)
    ...
    function u(e, t) {
        ...
        0 < (a = "string" == typeof (e = e || ".rellax") ? document.querySelectorAll(e) : [e]).length) {
            ...
            function A() {
                ...
                M = S < e[0] ? "xs" : S >= e[0] && S < e[1] ? "sm" : S >= e[1] && S < e[2] ? "md" : "lg",
                P(),
            ...
            var M, P = function() {
                ...
                for (var e = 0; e < T.elems.length; e++) {
                    var t = C[e].verticalScrollAxis.toLowerCase()
                      ...
                      , n = -1 != i.indexOf("x") ? o : 0
                      , i = -1 != i.indexOf("y") ? o : 0;
                    i = (s = I((s + n - C[e].left + S) / (C[e].width + S), (t + i - C[e].top + E) / (C[e].height + E), C[e].speed, C[e].verticalSpeed, C[e].horizontalSpeed)).y - C[e].baseY,
                    t = s.x - C[e].baseX,
                    null !== C[e].min && (T.options.vertical && !T.options.horizontal && (i = i <= C[e].min ? C[e].min : i),
                    T.options.horizontal && !T.options.vertical && (t = t <= C[e].min ? C[e].min : t)),
                    null != C[e].minY && (i = i <= C[e].minY ? C[e].minY : i),
                    null != C[e].minX && (t = t <= C[e].minX ? C[e].minX : t),
                    null !== C[e].max && (T.options.vertical && !T.options.horizontal && (i = i >= C[e].max ? C[e].max : i),
                    T.options.horizontal && !T.options.vertical && (t = t >= C[e].max ? C[e].max : t)),
                    null != C[e].maxY && (i = i >= C[e].maxY ? C[e].maxY : i),
                    null != C[e].maxX && (t = t >= C[e].maxX ? C[e].maxX : t),
                    T.elems[e].style[c] = "translate3d(" + (T.options.horizontal ? t : "0") + "px," + (T.options.vertical ? i : "0") + "px," + C[e].zindex + "px) " + C[e].transform
                }
            ...
            return T.destroy = function() {
                for (var e = 0; e < T.elems.length; e++)
                    T.elems[e].style.cssText = C[e].style;
                k || (window.removeEventListener("resize", A),
                k = !0),
                l(s),
                s = null
            }
...
function(a, h) {
    var t, n, p = "createElement", y = "getElementsByTagName", b = "length", w = "style", m = "title", f = "undefined", x = "setAttribute", _ = "getAttribute", T = null, g = "__svgInject", E = "--inject-", v = new RegExp(E + "\\d+","g"), S = "LOAD_FAIL", C = "SVG_INVALID", q = ["src", "alt", "onload", "onerror"], k = h[p]("a"), A = typeof SVGRect != f, u = {
        useCache: !0,
        copyAttributes: !0,
        makeIdsUnique: !0
    }, M = {
    ...
    function L(e, t) {
        var i, s, n, r = E + P++, o = /url\("?#([a-zA-Z][\w:.-]*)"?\)/g, a = e.querySelectorAll("[id]"), l = t ? [] : T, c = {}, d = [], u = !1;
        if (a[b]) {
            for (v = 0; v < a[b]; v++)
            ...
            for (var h, p, m, f = e[y]("*"), g = e, v = -1; g != T; ) {
                if (g.localName == w)
                    ...
                    for (n = 0; n < d[b]; n++)
                        h = d[n],
                        (m = (p = g[_](h)) && p.replace(o, function(e, t) {
                            return l && (l[t] = 1),
                            "url(#" + t + r + ")"
                        })) !== p && g[x](h, m);
    ...
    var e = function e(t, i) {
            ...
            if (r) {
                ...
                if (t)
                    ...
                    if (c) {
                        function s(e) {
                            var t, i, s, n;
                            e === S ? N(r, o) : e === C ? D(r, o) : (i = e[0],
                            s = e[1],
                            n = e[2],
                            d && (i === T ? (i = L(t = $(s, !1), !1),
                            e[0] = i,
                            e[2] = i && I(t)) : i && (s = n.replace(v, E + P++))),
                            t = t || $(s, !1),
                            O(r, t, l, o)),
                            a()
                        }
                    ...
                    u = function(e, t) {
                        ...
                        s && (s = s(e, t) || e) && (t = (i = "string" == typeof s) ? s : I(e),
                        e = i ? $(s, !0) : s),
        ...
        return A && (i = 'img[onload^="' + t + '("]{visibility:hidden;}',
...
function(e, t) {
    ...
    const i = {
                ...
                for (let e = 0; e < this.length; e += 1) {
                    ...
                    t && t.length)
                        for (let e = t.length - 1; 0 <= e; --e) {
                            const n = t[e];
                            (r && n.listener === r || r && n.listener && n.listener.dom7proxy && n.listener.dom7proxy === r || !r) && (s.removeEventListener(i, n.proxyListener, o),
                            t.splice(e, 1))
                        }
                }
            }
        ...
        prev: function(e) {
            ...
            e ? t.previousElementSibling && L(t.previousElementSibling).is(e) ? L([t.previousElementSibling]) : L([]) : t.previousElementSibling ? L([t.previousElementSibling]) : L([])) : L([])
        },
        prevAll: function(e) {
            const t = [];
            let i = this[0];
    ...
    function O(e, t) {
        ...
        return i.WebKitCSSMatrix ? (6 < (n = o.transform || o.webkitTransform).split(",").length && (n = n.split(", ").map(e => e.replace(",", ".")).join(", ")),
        ...
        for (let e = 1; e < arguments.length; e += 1) {
            ...
            !("undefined" != typeof window && void 0 !== window.HTMLElement ? a instanceof HTMLElement : a && (1 === a.nodeType || 11 === a.nodeType)))) {
                ...
                for (let e = 0, t = n.length; e < t; e += 1) {
                    ...
                    void 0 !== o && o.enumerable && (c(i[r]) && c(s[r]) ? s[r].__swiper__ ? i[r] = s[r] : m(i[r], s[r]) : !c(i[r]) && c(s[r]) ? (i[r] = {},
                    s[r].__swiper__ ? i[r] = s[r] : m(i[r], s[r])) : i[r] = s[r])
                }
            }
        }
        var a;
    ...
    function l(e) {
        ...
        let o = s;
        if (o = o || (r < e ? "next" : e < r ? "prev" : "reset"),
        t.emit("transition" + n),
        i && e !== r) {
            if ("reset" === o)
    ...
    const g = (e, t) => {
        ...
        s.updateOnWindowResize ? e[u](a.ios || a.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", h, !0) : e[u]("observerUpdate", h, !0)
    }
    ...
    const x = {
        eventsEmitter: {
            ...
            emit() {
                ...
                for (var n = arguments.length, r = new Array(n), o = 0; o < n; o++)
                    r[o] = arguments[o];
                return s = "string" == typeof r[0] || Array.isArray(r[0]) ? (t = r[0],
        ...
        update: {
            ...
            updateSlides: function() {
                ...
                let g = r.slidesOffsetBefore
                  , v = ("function" == typeof g && (g = r.slidesOffsetBefore.call(i)),
                r.slidesOffsetAfter);
                ...
                if (void 0 !== a) {
                    ...
                    r.centeredSlides && r.cssMode && (C(i.wrapperEl, "--swiper-centered-offset-before", ""),
                    ...
                    for (let e = 0; e < h; e += 1) {
                        t = 0;
                        const l = u.eq(e);
                        if (E && i.grid.updateSlide(e, l, h, s),
                        "none" !== l.css("display")) {
                            ...
                            f.push(t),
                            r.centeredSlides ? (x = x + t / 2 + _ / 2 + w,
                            0 === _ && 0 !== e && (x = x - a / 2 - w),
                            0 === e && (x = x - a / 2 - w),
                            Math.abs(x) < .001 && (x = 0),
                            ...
                            (T - Math.min(i.params.slidesPerGroupSkip, T)) % i.params.slidesPerGroup == 0 && p.push(x),
                            m.push(x),
                            x = x + t + w),
                            i.virtualSize += t + w,
                            _ = t,
                    ...
                    if (i.virtualSize = Math.max(i.virtualSize, a) + v,
                    l && c && ("slide" === r.effect || "coverflow" === r.effect) && o.css({
                        width: i.virtualSize + r.spaceBetween + "px"
                    }),
                    r.setWrapperSize && o.css({
                        [s("width")]: i.virtualSize + r.spaceBetween + "px"
                    }),
                    E && i.grid.updateWrapperSize(t, p, s),
                    !r.centeredSlides) {
                        const s = [];
                        ...
                        p = s,
                        1 < Math.floor(i.virtualSize - a) - Math.floor(p[p.length - 1]) && p.push(i.virtualSize - a)
                    }
                    if (0 === p.length && (p = [0]),
                    0 !== r.spaceBetween) {
                    ...
                    if (h !== e && i.emit("slidesLengthChange"),
            ...
            updateSlidesProgress: function(e) {
                ...
                if (0 !== r.length) {
                    ...
                    for (let t = 0; t < r.length; t += 1) {
                        ...
                        (0 <= d && d < s.size - 1 || 1 < u && u <= s.size || d <= 0 && u >= s.size) && (s.visibleSlides.push(l),
            ...
            updateSlidesClasses: function() {
                ...
                let o, a = (e.removeClass(`${t.slideActiveClass} ${t.slideNextClass} ${t.slidePrevClass} ${t.slideDuplicateActiveClass} ${t.slideDuplicateNextClass} ` + t.slideDuplicatePrevClass),
                ...
                o.nextAll("." + t.slideClass).eq(0).addClass(t.slideNextClass)), l = (t.loop && 0 === a.length && (a = e.eq(0)).addClass(t.slideNextClass),
                o.prevAll("." + t.slideClass).eq(0).addClass(t.slidePrevClass));
            ...
            updateClickedSlide: function(e) {
                ...
                t.clickedSlide = s,
                t.virtual && t.params.virtual.enabled ? t.clickedIndex = parseInt(L(s).attr("data-swiper-slide-index"), 10) : t.clickedIndex = n,
        ...
        translate: {
            ...
            setTranslate: function(e, t) {
                ...
                c = Math.floor(c)),
                n.cssMode ? o[i.isHorizontal() ? "scrollLeft" : "scrollTop"] = i.isHorizontal() ? -l : -c : n.virtualTranslate || r.transform(`translate3d(${l}px, ${c}px, 0px)`),
        ...
        slide: {
            slideTo: function(e, t, i, s, n) {
                ...
                (u || a.initialSlide || 0) === (d || 0) && i && r.emit("beforeSlideChangeStart");
                var g = -l[f];
            ...
            slidePrev: function(e, t, i) {
                ...
                let m = 0;
                if (void 0 !== p && ((m = a.indexOf(p)) < 0 && (m = s.activeIndex - 1),
            ...
            slideToClickedSlide: function() {
                ...
                t.loop ? e.animating || (n = parseInt(L(e.clickedSlide).attr("data-swiper-slide-index"), 10),
        ...
        loop: {
            ...
            loopFix: function() {
                var e = this
                  , {activeIndex: t, slides: i, loopedSlides: s, allowSlidePrev: n, allowSlideNext: r, snapGrid: o, rtlTranslate: a} = (e.emit("beforeLoopFix"),
                e);
                let l;
                e.allowSlidePrev = !0,
                e.allowSlideNext = !0;
                ...
                l += s,
                e.slideTo(l, 0, !1, !0) && 0 != o && e.setTranslate((a ? -e.translate : e.translate) - o)) : t >= i.length - s && (l = -i.length + t + s,
                l += s,
                e.slideTo(l, 0, !1, !0) && 0 != o && e.setTranslate((a ? -e.translate : e.translate) - o)),
                e.allowSlidePrev = n,
                e.allowSlideNext = r,
                e.emit("loopFix")
            },
            ...
            attachEvents: function() {
                ...
                e.onTouchStart = function(e) {
                    ...
                    if (t && (!s.animating || !a.preventInteractionOnTransition)) {
                        ...
                        if (("wrapper" !== a.touchEventsTarget || i.closest(s.wrapperEl).length) && (o.isTouchEvent = "touchstart" === t.type,
                        (o.isTouchEvent || !("which"in t) || 3 !== t.which) && !(!o.isTouchEvent && "button"in t && 0 < t.button || o.isTouched && o.isMoved))) {
                            ...
                            if (a.noSwiping && (d ? function(s, e) {
                                ...
                                "touchstart" !== t.type) {
                                    ...
                                    "SELECT" === i[0].nodeName && (o.isTouched = !1)),
                                    n.activeElement && L(n.activeElement).is(o.focusableElements) && n.activeElement !== i[0] && n.activeElement.blur();
                                ...
                                s.params.freeMode && s.params.freeMode.enabled && s.freeMode && s.animating && !a.cssMode && s.freeMode.onTouchStart(),
                                s.emit("touchStart", t)
                            }
                        }
                    }
                        ...
                        o.isTouched) {
                            if (!o.isTouchEvent || "touchmove" === s.type) {
                                ...
                                if (s.preventedByNestedSwiper)
                                    ...
                                    void (l.startY = n);
                                if (!r.allowTouchMove)
                                    return L(s.target).is(o.focusableElements) || (r.allowClick = !1),
                                    void (o.isTouched && (Object.assign(l, {
                                        startX: d,
                                        startY: n,
                                        currentX: d,
                                        currentY: n
                                ...
                                if (o.isTouchEvent && e.activeElement && s.target === e.activeElement && L(s.target).is(o.focusableElements))
                                    return o.isMoved = !0,
                                    void (r.allowClick = !1);
                                if (o.allowTouchCallbacks && r.emit("touchMove", s),
                                !(s.targetTouches && 1 < s.targetTouches.length)) {
                                    ...
                                    if (!(r.params.threshold && Math.sqrt(d ** 2 + n ** 2) < r.params.threshold))
                                        if (void 0 === o.isScrolling && (r.isHorizontal() && l.currentY === l.startY || r.isVertical() && l.currentX === l.startX ? o.isScrolling = !1 : 25 <= d * d + n * n && (i = 180 * Math.atan2(Math.abs(n), Math.abs(d)) / Math.PI,
                                        o.isScrolling = r.isHorizontal() ? i > a.touchAngle : 90 - i > a.touchAngle)),
                                        ...
                                        o.isScrolling)
                                            ...
                                            o.isMoved || (a.loop && !a.cssMode && r.loopFix(),
                                            ...
                                            !0)
                                              , i = a.resistanceRatio;
                                            if (a.touchReleaseOnEdges && (i = 0),
                                            0 < e && o.currentTranslate > r.minTranslate() ? (t = !1,
                                            a.resistance && (o.currentTranslate = r.minTranslate() - 1 + (-r.minTranslate() + o.startTranslate + e) ** i)) : e < 0 && o.currentTranslate < r.maxTranslate() && (t = !1,
                                            a.resistance && (o.currentTranslate = r.maxTranslate() + 1 - (r.maxTranslate() - o.startTranslate - e) ** i)),
                                            ...
                                            0 < a.threshold) {
                                                ...
                                                if (!o.allowThresholdMove)
                                                    ...
                                                    void (l.diff = r.isHorizontal() ? l.currentX - l.startX : l.currentY - l.startY)
                                            }
                                            a.followFinger && !a.cssMode && ((a.freeMode && a.freeMode.enabled && r.freeMode || a.watchSlidesProgress) && (r.updateActiveIndex(),
                                            r.updateSlidesClasses()),
                                            r.params.freeMode && a.freeMode.enabled && r.freeMode && r.freeMode.onTouchMove(),
                ...
                e.onTouchEnd = function(r) {
                    ...
                    if (s) {
                        ...
                        !e.isTouched)
                            return e.isMoved && a.grabCursor && o.setGrabCursor(!1),
                            e.isMoved = !1,
                        ...
                        if (o.allowClick) {
                            ...
                            o.updateClickedSlide(r && r[0] || n.target),
                            o.emit("tap click", n),
                            u < 300 && d - e.lastClickTime < 300 && o.emit("doubleTap doubleClick", n)
                        }
                        ...
                        e.isMoved = !1,
                        e.startMoving = !1,
                        c = a.followFinger ? i ? o.translate : -o.translate : -e.currentTranslate,
                        !a.cssMode)
                            if (o.params.freeMode && a.freeMode.enabled)
                                ...
                                for (let e = 0; e < l.length; e += e < a.slidesPerGroupSkip ? 1 : a.slidesPerGroup) {
                                    ...
                                    void 0 !== l[e + o] ? c >= l[e] && c < l[e + o] && (t = e,
                                    i = l[e + o] - l[e]) : c >= l[e] && (t = e,
                                ...
                                r = (c - l[t]) / i,
                                d = t < a.slidesPerGroupSkip - 1 ? 1 : a.slidesPerGroup;
                                u > a.longSwipesMs ? a.longSwipes ? ("next" === o.swipeDirection && (r >= a.longSwipesRatio ? o.slideTo(a.rewind && o.isEnd ? e : t + d) : o.slideTo(t)),
                                "prev" === o.swipeDirection && (r > 1 - a.longSwipesRatio ? o.slideTo(t + d) : null !== s && r < 0 && Math.abs(r) > a.longSwipesRatio ? o.slideTo(s) : o.slideTo(t))) : o.slideTo(o.activeIndex) : a.shortSwipes ? !o.navigation || n.target !== o.navigation.nextEl && n.target !== o.navigation.prevEl ? ("next" === o.swipeDirection && o.slideTo(null !== e ? e : t + d),
                                "prev" === o.swipeDirection && o.slideTo(null !== s ? s : t)) : n.target === o.navigation.nextEl ? o.slideTo(t + d) : o.slideTo(t) : o.slideTo(o.activeIndex)
                            }
                    }
                }
                .bind(e),
                ...
                .bind(e),
                s.touch && !p && (t.addEventListener("touchstart", j),
                p = !0),
                g(e, "on")
            },
                ...
                if (o && 0 !== Object.keys(o).length) {
                    ...
                    if (a && s.currentBreakpoint !== a) {
                        const d = (a in o ? o[a] : void 0) || s.originalParams
                          ...
                          , h = b(s, d)
                          , p = n.enabled;
                        u && !h ? (r.removeClass(`${n.containerModifierClass}grid ${n.containerModifierClass}grid-column`),
                        s.emitContainerClasses()) : !u && h && (r.addClass(n.containerModifierClass + "grid"),
                        (d.grid.fill && "column" === d.grid.fill || !d.grid.fill && "column" === n.grid.fill) && r.addClass(n.containerModifierClass + "grid-column"),
        ...
        images: {
            loadImage: function(e, t, i, s, n, r) {
                ...
                !(L(e).parent("picture")[0] || e.complete && n) && t ? ((a = new o.Image).onload = l,
                a.onerror = l,
                s && (a.sizes = s),
                i && (a.srcset = i),
                t && (a.src = t)) : l()
        ...
        constructor() {
            ...
            d = d || function() {
                ...
                var e = n.match(/(iPod)(.*OS\s([\d_]+))?/)
                  ...
                  , u = "Win32" === s;
                let h = "MacIntel" === s;
                return !c && h && t.touch && 0 <= ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(o + "x" + a) && (c = (c = n.match(/(Version)\/([\d.]+)/)) || [0, 1, "13_0_0"],
                h = !1),
                l && !u && (r.os = "android",
                r.android = !0),
                (c || d || e) && (r.os = "ios",
    ...
    function k(i, s, n, r) {
        ...
        return i.params.createElements && Object.keys(r).forEach(t => {
            if (!n[t] && !0 === n.auto) {
                ...
                e || ((e = o.createElement("div")).className = r[t],
                i.$el.append(e)),
                n[t] = e,
                s[t] = e
            }
    ...
    function z(e, t, i) {
        ...
        let r = n.children("." + s);
        return r.length || (r = L(`<div class="swiper-slide-shadow${i ? "-" + i : ""}"></div>`),
        n.append(r)),
        r
    }
    ...
    T.use([function(e) {
        ...
        function o(t) {
            ...
            m = s ? (p = Math.floor(e / 2) + i + r,
            Math.floor(e / 2) + i + n) : (p = e + (i - 1) + r,
            i + n);
            ...
            o === f && a === g && !t)
                return x.slidesGrid !== c && v !== d && x.slides.css(h, v + "px"),
                x.updateProgress(),
                void _("virtualUpdate");
            ...
            for (let e = 0; e < l.length; e += 1)
                e >= f && e <= g && (void 0 === a || t ? w.push(e) : (e > a && w.push(e),
                e < o && b.push(e)));
            w.forEach(e => {
        ...
        s("setTranslate", () => {
            x.params.virtual.enabled && (x.params.cssMode && !x._immediateVirtual ? (clearTimeout(t),
            t = setTimeout( () => {
                o()
            }
            , 100)) : o())
    ...
    , function(e) {
        ...
        function n() {
            u.keyboard.enabled || (L(p).on("keydown", s),
            u.keyboard.enabled = !0)
        }
        function r() {
            u.keyboard.enabled && (L(p).off("keydown", s),
    ...
    , function(e) {
        ...
        function a(s) {
            ...
            if (c.enabled) {
                ...
                let e = c.$el;
                if ("container" !== c.params.mousewheel.eventsTarget && (e = L(c.params.mousewheel.eventsTarget)),
                !c.mouseEntered && !e[0].contains(n.target) && !o.releaseOnEdges)
                    return !0;
                ...
                (r = !!c.params.loop || !(i === c.minTranslate() || i === c.maxTranslate())) && c.params.nested && n.stopPropagation(),
                c.params.freeMode && c.params.freeMode.enabled) {
                    ...
                    if (!r) {
                        ...
                        (!L && c.isBeginning || !v && c.isEnd) && c.updateSlidesClasses(),
        ...
        function l(e) {
            let t = c.$el;
            (t = "container" !== c.params.mousewheel.eventsTarget ? L(c.params.mousewheel.eventsTarget) : t)[e]("mouseenter", r),
            t[e]("mouseleave", o),
            t[e]("wheel", a)
        }
        function f() {
            return c.params.cssMode ? (c.wrapperEl.removeEventListener("wheel", a),
            !0) : !c.mousewheel.enabled && (l("on"),
            c.mousewheel.enabled = !0)
        }
        function g() {
            return c.params.cssMode ? (c.wrapperEl.addEventListener(event, a),
    ...
    , function(e) {
        ...
        function s(e) {
            let t;
            return e && (t = L(e),
            r.params.uniqueNavElements && "string" == typeof e && 1 < t.length && 1 === r.$el.find(e).length && (t = r.$el.find(e))),
            t
        }
        function n(e, t) {
            ...
            r.params.watchOverflow && r.enabled && e[r.isLocked ? "addClass" : "removeClass"](i.lockClass))
        }
        function a() {
            var e, t;
            r.params.loop || ({$nextEl: e, $prevEl: t} = r.navigation,
        ...
        function d() {
            ...
            e.nextEl || e.prevEl) {
                ...
                r.enabled || (t && t.addClass(e.lockClass),
        ...
        i("init", () => {
            !1 === r.params.navigation.enabled ? h() : (d(),
            a())
        }
        ),
        ...
        i("click", (e, t) => {
            ...
            if (r.params.navigation.hideOnClick && !L(n).is(s) && !L(n).is(i) && (!(r.pagination && r.params.pagination && r.params.pagination.clickable) || r.pagination.el !== n && !r.pagination.el.contains(n))) {
                let e;
                i ? e = i.hasClass(r.params.navigation.hiddenClass) : s && (e = s.hasClass(r.params.navigation.hiddenClass)),
    ...
    , function(e) {
        ...
        function s() {
            ...
            if (!r()) {
                ...
                if (c.params.loop ? ((r = Math.ceil((c.activeIndex - c.loopedSlides) / c.params.slidesPerGroup)) > a - 1 - 2 * c.loopedSlides && (r -= a - 2 * c.loopedSlides),
                r > i - 1 && (r -= i),
                r < 0 && "bullets" !== c.params.paginationType && (r = i + r)) : r = void 0 !== c.snapIndex ? c.snapIndex : c.activeIndex || 0,
                "bullets" === o.type && c.pagination.bullets && 0 < c.pagination.bullets.length) {
                    const a = c.pagination.bullets;
                    let s, n, e;
                    if (o.dynamicBullets && (u = a.eq(0)[c.isHorizontal() ? "outerWidth" : "outerHeight"](!0),
                    l.css(c.isHorizontal() ? "width" : "height", u * (o.dynamicMainBullets + 4) + "px"),
                    1 < o.dynamicMainBullets && void 0 !== c.previousIndex && ((h += r - (c.previousIndex - c.loopedSlides || 0)) > o.dynamicMainBullets - 1 ? h = o.dynamicMainBullets - 1 : h < 0 && (h = 0)),
                    s = Math.max(r - h, 0),
                    n = s + (Math.min(a.length, o.dynamicMainBullets) - 1),
                    e = (n + s) / 2),
                    a.removeClass(["", "-next", "-next-next", "-prev", "-prev-prev", "-main"].map(e => "" + o.bulletActiveClass + e).join(" ")),
                    1 < l.length)
                        a.each(e => {
                            const t = L(e)
                              , i = t.index();
                            i === r && t.addClass(o.bulletActiveClass),
                            o.dynamicBullets && (i >= s && i <= n && t.addClass(o.bulletActiveClass + "-main"),
                            i === s && p(t, "prev"),
                            i === n && p(t, "next"))
                        }
                        );
                        ...
                        const t = a.eq(r)
                          , l = t.index();
                        if (t.addClass(o.bulletActiveClass),
                        o.dynamicBullets) {
                            const t = a.eq(s)
                              , u = a.eq(n);
                            for (let e = s; e <= n; e += 1)
                ...
                if ("fraction" === o.type && (l.find(A(o.currentClass)).text(o.formatFractionCurrent(r + 1)),
                ...
                "progressbar" === o.type) {
                    ...
                    let e = 1
                      , t = 1;
                    "horizontal" == s ? e = a : t = a,
                    l.find(A(o.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${e}) scaleY(${t})`).transition(c.params.speed)
                }
                "custom" === o.type && o.renderCustom ? (l.html(o.renderCustom(c, r + 1, i)),
                d("paginationRender", l[0])) : d("paginationUpdate", l[0]),
                c.params.watchOverflow && c.enabled && l[c.isLocked ? "addClass" : "removeClass"](o.lockClass)
            }
        }
        function n() {
        ...
        function o() {
            ...
            if (t.el) {
                let e = L(t.el);
                0 !== e.length && (c.params.uniqueNavElements && "string" == typeof t.el && 1 < e.length && (1 < (e = c.$el.find(t.el)).length && (e = e.filter(e => L(e).parents(".swiper")[0] === c.el))),
        ...
        i("init", () => {
            !1 === c.params.pagination.enabled ? l() : (o(),
            n(),
            s())
        }
        ),
        ...
        const l = () => {
            ...
            c.pagination.$el && c.pagination.$el.addClass(c.params.pagination.paginationDisabledClass),
            a()
        }
        ;
        Object.assign(c.pagination, {
            enable: () => {
                ...
                c.pagination.$el && c.pagination.$el.removeClass(c.params.pagination.paginationDisabledClass),
                o(),
                n(),
                s()
            }
    ...
    , function(e) {
        ...
        function n() {
            if (c.params.scrollbar.el && c.scrollbar.el) {
                ...
                let e = l
                  , t = (u - l) * n;
                s ? 0 < (t = -t) ? (e = l - t,
                t = 0) : -t + l > u && (e = u + t) : t < 0 ? (e = l + t,
                t = 0) : t + l > u && (e = u - t),
                c.isHorizontal() ? (r.transform(`translate3d(${t}px, 0, 0)`),
                r[0].style.width = e + "px") : (r.transform(`translate3d(0px, ${t}px, 0)`),
        ...
        function r() {
            if (c.params.scrollbar.el && c.scrollbar.el) {
                ...
                l = "auto" === c.params.scrollbar.dragSize ? u * s : parseInt(c.params.scrollbar.dragSize, 10),
        ...
        function g(e) {
            const {scrollbar: t, rtlTranslate: i} = c
              , s = t["$el"];
            let n;
            n = (f(e) - s.offset()[c.isHorizontal() ? "left" : "top"] - (null !== a ? a : l / 2)) / (u - l),
        ...
        function v(e) {
            const t = c.params.scrollbar
              ...
              , {$el: n, $dragEl: r} = i;
            h = !0,
            a = e.target === r[0] || e.target === r ? f(e) - e.target.getBoundingClientRect()[c.isHorizontal() ? "left" : "top"] : null,
            e.preventDefault(),
            e.stopPropagation(),
            s.transition(100),
            r.transition(100),
        ...
        function w(e) {
            ...
            if (t) {
                ...
                o && (t = "on" === e ? "addEventListener" : "removeEventListener",
                r.touch ? (o[t](i.start, v, a),
                o[t](i.move, y, a),
                o[t](i.end, b, l)) : (o[t](s.start, v, a),
                d[t](s.move, y, a),
                d[t](s.end, b, l)))
            }
        }
        function x() {
            ...
            if (n.el) {
                let e = L(n.el)
                  , t = ((e = c.params.uniqueNavElements && "string" == typeof n.el && 1 < e.length && 1 === s.find(n.el).length ? s.find(n.el) : e).addClass(c.isHorizontal() ? n.horizontalClass : n.verticalClass),
                e.find("." + c.params.scrollbar.dragClass));
                0 === t.length && (t = L(`<div class="${c.params.scrollbar.dragClass}"></div>`),
                e.append(t)),
                Object.assign(i, {
                    $el: e,
                    el: e[0],
                ...
                n.draggable && c.params.scrollbar.el && c.scrollbar.el && w("on"),
        ...
        function _() {
            const e = c.params.scrollbar
              , t = c.scrollbar.$el;
            t && t.removeClass(c.isHorizontal() ? e.horizontalClass : e.verticalClass),
            c.params.scrollbar.el && c.scrollbar.el && w("off")
        }
        t({
            scrollbar: {
                el: null,
        ...
        i("init", () => {
            !1 === c.params.scrollbar.enabled ? T() : (x(),
            r(),
            n())
        }
        ),
        ...
        const T = () => {
            c.$el.addClass(c.params.scrollbar.scrollbarDisabledClass),
            c.scrollbar.$el && c.scrollbar.$el.addClass(c.params.scrollbar.scrollbarDisabledClass),
            _()
        }
        ;
        Object.assign(c.scrollbar, {
            enable: () => {
                c.$el.removeClass(c.params.scrollbar.scrollbarDisabledClass),
                c.scrollbar.$el && c.scrollbar.$el.removeClass(c.params.scrollbar.scrollbarDisabledClass),
                x(),
                r(),
                n()
            }
        ...
        const r = (e, t) => {
          ...
          , s = () => {
            ...
            t.each( (e, t) => {
                ...
                L(e).find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each(e => {
                    r(e, i)
                }
                )
            }
    ...
    , function(e) {
        ...
        function u(e) {
            ...
            E.$slideEl && E.$slideEl.length || (E.$slideEl = L(e.target).closest("." + x.params.slideClass),
            0 === E.$slideEl.length && (E.$slideEl = x.slides.eq(x.activeIndex)),
            E.$imageEl = E.$slideEl.find("." + i.containerClass).eq(0).find("picture, img, svg, canvas, .swiper-zoom-target").eq(0),
        ...
        function h(e) {
            ...
            E.$imageEl && 0 !== E.$imageEl.length ? (t.gestures ? s.scale = e.scale * T : s.scale = E.scaleMove / E.scaleStart * T,
            s.scale > E.maxRatio && (s.scale = E.maxRatio - 1 + (s.scale - E.maxRatio + 1) ** .5),
            s.scale < i.minRatio && (s.scale = i.minRatio + 1 - (i.minRatio - s.scale + 1) ** .5),
            E.$imageEl.transform(`translate3d(0,0,0) scale(${s.scale})`)) : "gesturechange" === e.type && u(e)
        }
        function p(e) {
            const t = x.device
              , i = x.support
            ...
            E.$imageEl && 0 !== E.$imageEl.length && (n.scale = Math.max(Math.min(n.scale, E.maxRatio), s.minRatio),
            E.$imageEl.transition(x.params.speed).transform(`translate3d(0,0,0) scale(${n.scale})`),
            T = n.scale,
            a = !1,
        ...
        function m(e) {
            ...
            S.isTouched && E.$slideEl)) {
                S.isMoved || (S.width = E.$imageEl[0].offsetWidth,
                S.height = E.$imageEl[0].offsetHeight,
                S.startX = O(E.$imageWrapEl[0], "x") || 0,
                S.startY = O(E.$imageWrapEl[0], "y") || 0,
                ...
                if (!(i < E.slideWidth && t < E.slideHeight)) {
                    if (S.minX = Math.min(E.slideWidth / 2 - i / 2, 0),
                    S.maxX = -S.minX,
                    S.minY = Math.min(E.slideHeight / 2 - t / 2, 0),
                    S.maxY = -S.minY,
                    ...
                    l.prevTime = Date.now(),
                    E.$imageWrapEl.transform(`translate3d(${S.currentX}px, ${S.currentY}px,0)`)
                }
            }
        }
        function f() {
        ...
        function g(y) {
            const b = x.zoom
              , w = x.params.zoom;
            if (E.$slideEl || (y && y.target && (E.$slideEl = L(y.target).closest("." + x.params.slideClass)),
            ...
            E.$imageEl && 0 !== E.$imageEl.length && E.$imageWrapEl && 0 !== E.$imageWrapEl.length) {
                ...
                i = E.$slideEl.offset().left + _.scrollX,
                s = E.$slideEl.offset().top + _.scrollY,
                n = i + g / 2 - e,
                r = s + v / 2 - t,
                ...
                (a = a < p ? p : a) > f && (a = f)) : (o = 0,
                a = 0),
                E.$imageWrapEl.transition(300).transform(`translate3d(${o}px, ${a}px,0)`),
        ...
        function C(e) {
            ...
            x.$wrapperEl[e]("gestureend", i, p, t)
        }
        function k() {
            n || (n = !0,
            C("on"))
        ...
        function M() {
            ...
            n = w(),
            t.gestures ? (x.$wrapperEl.on(x.touchEvents.start, k, i),
            x.$wrapperEl.on(x.touchEvents.end, A, i)) : "touchstart" === x.touchEvents.start && (x.$wrapperEl.on(x.touchEvents.start, n, u, i),
            x.$wrapperEl.on(x.touchEvents.move, n, h, s),
            x.$wrapperEl.on(x.touchEvents.end, n, p, i),
            x.touchEvents.cancel && x.$wrapperEl.on(x.touchEvents.cancel, n, p, i)),
            x.$wrapperEl.on(x.touchEvents.move, "." + x.params.zoom.containerClass, m, s))
        }
        function P() {
            const e = x.zoom;
            var t, i, s, n;
            ...
            b()),
            n = w(),
            t.gestures ? (x.$wrapperEl.off(x.touchEvents.start, k, i),
            x.$wrapperEl.off(x.touchEvents.end, A, i)) : "touchstart" === x.touchEvents.start && (x.$wrapperEl.off(x.touchEvents.start, n, u, i),
            x.$wrapperEl.off(x.touchEvents.move, n, h, s),
            x.$wrapperEl.off(x.touchEvents.end, n, p, i),
            x.touchEvents.cancel && x.$wrapperEl.off(x.touchEvents.cancel, n, p, i)),
            x.$wrapperEl.off(x.touchEvents.move, "." + x.params.zoom.containerClass, m, s))
        }
        Object.defineProperty(x.zoom, "scale", {
            get: () => c,
            set(e) {
                var t, i;
                c !== e && (t = E.$imageEl ? E.$imageEl[0] : void 0,
        ...
        i("touchStart", (e, t) => {
            ...
            x.zoom.enabled && (t = t,
            i = x.device,
            E.$imageEl && 0 !== E.$imageEl.length && !S.isTouched && (i.android && t.cancelable && t.preventDefault(),
            S.isTouched = !0,
            ...
            if (x.zoom.enabled) {
                ...
                if (E.$imageEl && 0 !== E.$imageEl.length) {
                    ...
                    var s = l.x * e
                      ...
                      , n = l.y * t
                      , n = S.currentY + n
                      , r = (0 !== l.x && (e = Math.abs((s - S.currentX) / l.x)),
                    ...
                    S.width * i.scale)
                      , n = S.height * i.scale;
                    S.minX = Math.min(E.slideWidth / 2 - s / 2, 0),
                    S.maxX = -S.minX,
                    S.minY = Math.min(E.slideHeight / 2 - n / 2, 0),
                    S.maxY = -S.minY,
                    S.currentX = Math.max(Math.min(S.currentX, S.maxX), S.minX),
                    S.currentY = Math.max(Math.min(S.currentY, S.maxY), S.minY),
                    E.$imageWrapEl.transition(r).transform(`translate3d(${S.currentX}px, ${S.currentY}px,0)`)
                }
            }
        }
        ),
            ...
            if (void 0 !== e && 0 !== d.slides.length) {
                ...
                0 !== t.length && t.each(e => {
                    ...
                    d.loadImage(t[0], s || i, n, r, !1, () => {
                        ...
                        o.length && o.children("source").each(e => {
                            const t = L(e);
                        ...
                        d.params.loop && a && (e = c.attr("data-swiper-slide-index"),
        ...
        Object.assign(a.controller, {
            setTranslate: function(e, t) {
                ...
                function o(e) {
                    ...
                    "slide" === a.params.controller.by && (t = e,
                    a.controller.spline || (a.controller.spline = a.params.loop ? new l(a.slidesGrid,t.slidesGrid) : new l(a.snapGrid,t.snapGrid)),
    ...
    , function(e) {
        ...
        function p(e) {
            if (13 === e.keyCode || 32 === e.keyCode) {
                const t = o.params.a11y
                  , i = L(e.target);
                o.navigation && o.navigation.$nextEl && i.is(o.navigation.$nextEl) && (o.isEnd && !o.params.loop || o.slideNext(),
                o.isEnd ? s(t.lastSlideMessage) : s(t.nextSlideMessage)),
                o.navigation && o.navigation.$prevEl && i.is(o.navigation.$prevEl) && (o.isBeginning && !o.params.loop || o.slidePrev(),
                o.isBeginning ? s(t.firstSlideMessage) : s(t.prevSlideMessage)),
                o.pagination && i.is(A(o.params.pagination.bulletClass)) && i[0].click()
            }
        }
        function m() {
        ...
        const g = (e, t, i) => {
          ...
          , v = e => {
            ...
            e && o.slides.includes(e) && (t = o.slides.indexOf(e) === o.activeIndex,
            i = o.params.watchSlidesProgress && o.visibleSlides && o.visibleSlides.includes(e),
            t || i || (o.isHorizontal() ? o.el.scrollLeft = 0 : o.el.scrollTop = 0,
            o.slideTo(o.slides.indexOf(e), 0)))
        }
          , y = () => {
            const n = o.params.a11y
              , r = (n.itemRoleDescriptionMessage && c(L(o.slides), n.itemRoleDescriptionMessage),
            n.slideRole && l(L(o.slides), n.slideRole),
            (o.params.loop ? o.slides.filter(e => !e.classList.contains(o.params.slideDuplicateClass)) : o.slides).length);
        ...
        i("afterInit", () => {
            if (o.params.a11y.enabled) {
                ...
                e && e.length && g(e, r, i.nextSlideMessage),
                t && t.length && g(t, r, i.prevSlideMessage),
                f() && o.pagination.$el.on("keydown", A(o.params.pagination.bulletClass), p),
                o.$el.on("focus", v, !0)
            }
        }
        ),
        ...
        i("fromEdge toEdge afterInit lock unlock", () => {
            ...
            t && 0 < t.length && (o.isBeginning ? (u(t),
            r(t)) : (h(t),
            n(t))),
            e && 0 < e.length && (o.isEnd ? (u(e),
            r(e)) : (h(e),
            n(e))))
        }
        ),
        i("paginationUpdate", () => {
            if (o.params.a11y.enabled) {
                ...
                m() && o.pagination.bullets.each(e => {
                    const t = L(e);
                    o.params.pagination.clickable && (n(t),
                    o.params.pagination.renderBullet || (l(t, "button"),
                    d(t, i.paginationBulletMessage.replace(/\{\{index\}\}/, t.index() + 1)))),
                    t.is("." + o.params.pagination.bulletActiveClass) ? t.attr("aria-current", "true") : t.removeAttr("aria-current")
                }
                )
            }
        }
        ...
        i("destroy", () => {
            if (o.params.a11y.enabled) {
                ...
                e && e.off("keydown", p),
                t && t.off("keydown", p),
                f() && o.pagination.$el.off("keydown", A(o.params.pagination.bulletClass), p),
                o.$el.off("focus", v, !0)
            }
        }
        )
        ...
        i("init", () => {
            if (o.params.history.enabled) {
                ...
                if (o.params.history) {
                    ...
                    o.params.history.replaceState || e.addEventListener("popstate", d))
                }
            }
        }
        ),
          ...
          , c = () => {
            if (r && n.params.hashNavigation.enabled)
                if (n.params.hashNavigation.replaceState && a.history && a.history.replaceState)
                    a.history.replaceState(null, null, "#" + n.slides.eq(n.activeIndex).attr("data-hash") || ""),
                    i("hashSet");
                else {
    ...
    , function(e) {
        ...
        function a() {
            return void 0 === i && !s.autoplay.running && (s.autoplay.running = !0,
            r("autoplayStart"),
            o(),
            !0)
        }
        function l() {
            return !!s.autoplay.running && void 0 !== i && (i && (clearTimeout(i),
            i = void 0),
        ...
        function c(e) {
            !s.autoplay.running || s.autoplay.paused || (i && clearTimeout(i),
            s.autoplay.paused = !0,
        ...
        function r() {
            ...
            if (e && !e.destroyed) {
                ...
                if (!(s && L(s).hasClass(l.params.thumbs.slideThumbActiveClass) || null == i)) {
                    let t;
                    if (t = e.params.loop ? parseInt(L(e.clickedSlide).attr("data-swiper-slide-index"), 10) : i,
                    l.params.loop) {
                        let e = l.activeIndex;
            ...
            freeMode: {
                ...
                onTouchEnd: function(r) {
                    ...
                    if (o < -h.minTranslate())
                        ...
                        (!a.freeMode.momentum || e >= a.longSwipesMs) && (h.updateProgress(),
                        h.updateActiveIndex(),
                        h.updateSlidesClasses())
                    }
                }
        ...
        m.grid = {
            ...
            updateSlide: (e, t, i, s) => {
                ...
                if ("row" === a && 1 < n) {
                    ...
                    "column" === a ? (c = Math.floor(e / o),
                    d = e - c * o,
                    (c > p || c === p && d === o - 1) && ((d += 1) >= o && (d = 0,
            ...
            updateWrapperSize: (i, s, e) => {
                ...
                if (m.virtualSize = (i + t) * u,
                m.virtualSize = Math.ceil(m.virtualSize / o) - t,
                m.$wrapperEl.css({
    ...
    , function(e) {
        ...
        Object.assign(e, {
            ...
            removeSlide: function(t) {
                ...
                e.loop && i.loopCreate(),
                e.observer || i.update(),
                e.loop ? i.slideTo(a + i.loopedSlides, 0, !1) : i.slideTo(a, 0, !1)
            }
            .bind(e),
            removeAllSlides: function() {
                const t = [];
    ...
    , function(e) {
        ...
        const g = (e, t, i) => {
            ...
            0 === s.length && (s = L(`<div class="swiper-slide-shadow-${i ? "left" : "top"}"></div>`),
            e.append(s)),
            0 === n.length && (n = L(`<div class="swiper-slide-shadow-${i ? "right" : "bottom"}"></div>`),
            e.append(n)),
        ...
        M({
            ...
            setTranslate: () => {
                ...
                let r, p = 0;
                d.shadow && (u ? (0 === (r = t.find(".swiper-cube-shadow")).length && (r = L('<div class="swiper-cube-shadow"></div>'),
                t.append(r)),
                r.css({
                    height: i + "px"
                })) : 0 === (r = e.find(".swiper-cube-shadow")).length && (r = L('<div class="swiper-cube-shadow"></div>'),
                e.append(r)));
                ...
                t.transform(`translate3d(0px,0,${o}px) rotateX(${f.isHorizontal() ? 0 : p}deg) rotateY(${f.isHorizontal() ? -p : 0}deg)`),
                t[0].style.setProperty("--swiper-cube-translate-z", o + "px")
            }
            ,
            setTransition: e => {
    ...
    , function(e) {
        ...
        const h = (e, t, i) => {
            ...
            0 === s.length && (s = z(i, e, u.isHorizontal() ? "left" : "top")),
            0 === n.length && (n = z(i, e, u.isHorizontal() ? "right" : "bottom")),
            s.length && (s[0].style.opacity = Math.max(-t, 0)),
            n.length && (n[0].style.opacity = Math.max(t, 0))
        }
        ;
        M({
            ...
            setTranslate: () => {
                ...
                for (let r = 0; r < o.length; r += 1) {
                    ...
                    i = -t,
                    t = 0),
                    d[0].style.zIndex = -Math.abs(Math.round(e)) + o.length,
                    l.slideShadows && h(d, e, l);
            ...
            recreateShadows: () => {
                ...
                u.slides.each(e => {
                    var t = L(e);
                    let i = t[0].progress;
                    u.params.flipEffect.limitRotation && (i = Math.max(Math.min(e.progress, 1), -1)),
                    h(t, i, s)
                }
                )
            }
            ...
            setTranslate: () => {
                ...
                for (let a = 0, e = c.length; a < e; a += 1) {
                    ...
                    let e = h ? f * y : 0
                      ...
                      , i = -g * Math.abs(y)
                      , s = u.stretch
                      , n = ("string" == typeof s && -1 !== s.indexOf("%") && (s = parseFloat(u.stretch) / 100 * l),
                    h ? 0 : s * y)
                      , r = h ? s * y : 0
                    ...
                    u.slideShadows) {
                        ...
                        0 === e.length && (e = z(u, b, h ? "left" : "top")),
                        0 === t.length && (t = z(u, b, h ? "right" : "bottom")),
        ...
        M({
            ...
            setTranslate: () => {
                ...
                for (let o = 0; o < a.length; o += 1) {
                    ...
                    if (t = y < 0 ? `calc(${t}px + (${r * Math.abs(y)}%))` : 0 < y ? `calc(${t}px + (-${r * Math.abs(y)}%))` : t + "px",
                    !b.isHorizontal()) {
                        const a = i;
                        i = t,
                        t = a
